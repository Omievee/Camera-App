...
class MyScaleGestures(c: Context?) : OnTouchListener, OnScaleGestureListener {
    ...
    override fun onScale(detector: ScaleGestureDetector): Boolean {
        ...
        scaleFactor =
            (scaleFactor * 100).toInt().toFloat() / 100 // Change precision to help with jitter when user just rests their fingers //
