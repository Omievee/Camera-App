...
interface VideoObjectDAO {
    ...
    @Query("UPDATE SavedVideo SET  uploadState = :uploadState, uploadId = :uploadId,id = :id,mediumRes = :mediumRes, trimmedVidPath = :trimmedVidPath, isProcessed = :isProcessed WHERE clientId = :lastID")
